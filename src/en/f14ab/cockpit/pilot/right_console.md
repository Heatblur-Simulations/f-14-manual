...
Contains controls to override failed spoiler sections, allowing the remaining
spoilers to continue operating after a MASTER RESET.

### Inboard and Outboard Spoiler Override Switch

Two-position switch (<num>1</num>) controlling the inboard spoiler override
function with two-position switch (<num>2</num>) controlling the outboard
spoiler override function.
...
Switches (<num>2</num>) and (<num>3</num>) are for the Video Tape Recorder
(VTR).
