...
The data stowage compartment provides storage space for equipment, documents,
and mission briefing materials.
...
The TACAN CMD switch (<num>3</num>) selects which crewmember controls TACAN and
indicates current authority.
