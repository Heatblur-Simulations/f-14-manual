...
Creating Liveries for our F-14 can be tedious work.
...
With the release of the F-14 Tomcat, we want to see what you have in store for
the F-14. To support you in your creative ways of recreating your favorite
...
> or on the [F-14A/B Forum](https://forum.dcs.world/forum/258-dcs-f-14a-b/) and
> [F-14B(U) Forum](https://forum.dcs.world/forum/1433-dcs-f-14bu/).

## Character Customization

The Phantom features [Character Customization](../character.md#customization).

To set the defaults for the liveries, this is done by modifying the
...
`\CoreMods\aircraft\F14\Liveries\F-14\commons`.
