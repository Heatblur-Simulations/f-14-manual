...
The three three-position switches (<num>1</num>, <num>2</num> and <num>3</num>)
...
The middle volume knob, <num>4</num>, controls the audio levels of the AN/ALR-45
...
The **AAA** switch (<num>10</num>) enables or disables display of strobes
...
The **UNKNOWN** switch (<num>6</num>) disables display of normal threats and
...
The three test switches (<num>7</num>, <num>8</num> and <num>9</num>) are all
...
The **ECM - CORR** switch (<num>1</num>) allows setting how the two systems
...
The **ECM - ORIDE** switch (<num>2</num>) controls when the ECM can override the
...
The **MODE** switch (<num>3</num>) selects which system to display on the
**ECMD**. **ECM** displays the ECM and **NAV** displays NAV.

The **DATA/ADF** switch (<num>4</num>) controls what additional text information
...
![Displays Control Panel](../../../cockpit/pilot/right_vertical_console.md#displays-control-panel)
...
![General](../../../img/general_alr-45_general.jpg)
![Strobes](../../../img/general_alr-45_strobes.jpg)
