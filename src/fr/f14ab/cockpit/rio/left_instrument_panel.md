...
L'altimètre servopneumatique fournit une indication d'altitude à l'aide de systèmes
électriques et de systèmes basés sur la pression.
...
les indicateurs utilisent une référence fixe de 29,92 po.Hg.
...
fonctionnant en mode de secours (veille) (non visible sur cette image).
...
Le pointeur d'indice de vitesse indiqué (<num>5</num>) peut être réglé pour marquer une
vitesse souhaitée.
...
Une position ajuste le pointeur d'indice de vitesse, et l'autre ajuste le pointeur
d'indice de Mach.

## Indicateur d'attitude de veille

![attitude d'attente](../../../img/cockpit_detail_rio_standbyattitude.jpg)
...
![télécommande arrière](../../../img/cockpit_detail_rio_backremote.jpg)
