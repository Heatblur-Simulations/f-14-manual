...
<https://f14.manuals.heatblur.se/>. PDF versions are available from the
...
To build the website locally, you have to install **mdBook**, see the
...
<https://github.com/Heatblur-Simulations/f-14-manual/releases> via CI/CD
